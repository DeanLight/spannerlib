...
#                     self.remove_project_node(union_id, project_id)
#
#     def remove_project_node(self, union_node, project_node) -> None:
#         """
...
#         """
#
#         # project node has exactly one child so we connect the child to project's node parent (the union node)
#         project_child = next(iter(self.term_graph.get_children(project_node)))
#         self.term_graph.add_edge(union_node, project_child)
