...
def get_base_file_path() -> Path: # The absolute path of parent folder of nbs
    ...
    index_of_spanner_workbench = current_dir.parts.index('spanner_workbench')
    current_dir = current_dir.joinpath(*path_parts[:index_of_spanner_workbench])
    return current_dir
...
def download_file_from_google_drive(file_id: str, # the id of the file to download
    ...
    """
    destination = Path(os.path.join(get_base_file_path(Path.cwd()),'spanner_workbench','stanford-corenlp-4.1.0.zip'))
