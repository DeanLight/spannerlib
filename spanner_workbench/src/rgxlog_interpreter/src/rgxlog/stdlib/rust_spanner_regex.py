# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb.
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 3
import logging
import re
import tempfile
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 5
RUST_RGX_IN_TYPES = [DataTypes.string, DataTypes.string]

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 7
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 9
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 11
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 13
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 15
WINDOWS_OS = "win32"
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 17
ESCAPED_STRINGS_PATTERN = re.compile(r'"([^"\\]*(?:\\.[^"\\]*)*)"', re.DOTALL)
SPAN_PATTERN = re.compile(r"(?P<start>\d+), ?(?P<end>\d+)")

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 18
# etc
TEMP_FILE_NAME = "temp"

logger = logging.getLogger(__name__)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 19
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 20
def _is_installed_package() -> bool:
    return Path(REGEX_EXE_PATH).is_file()

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 21
@no_type_check
def rgx_span_out_type(output_arity: int) -> Tuple[DataTypes]:
    return tuple([DataTypes.span] * output_arity)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 22
@no_type_check
def rgx_string_out_type(output_arity: int) -> Tuple[DataTypes]:
    return tuple([DataTypes.string] * output_arity)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 23
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 24
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 25
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 26
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 27
RGX = dict(ie_function=rgx_span,
           ie_function_name='rgx_span',
           in_rel=RUST_RGX_IN_TYPES,
           out_rel=rgx_span_out_type)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 28
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 29
RGX_STRING = dict(ie_function=rgx_string,
                  ie_function_name='rgx_string',
                  in_rel=RUST_RGX_IN_TYPES,
                  out_rel=rgx_string_out_type)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 30
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 31
RGX_FROM_FILE = dict(ie_function=rgx_span_from_file,
                     ie_function_name='rgx_span_from_file',
                     in_rel=RUST_RGX_IN_TYPES,
                     out_rel=rgx_span_out_type)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 32
...
# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 33
RGX_STRING_FROM_FILE = dict(ie_function=rgx_string_from_file,
                            ie_function_name='rgx_string_from_file',
                            in_rel=RUST_RGX_IN_TYPES,
                            out_rel=rgx_string_out_type)

# %% ../../../../../../nbs/17_src.rgxlog_interpreter.src.rgxlog.stdlib.rust_spanner_regex.ipynb 34
