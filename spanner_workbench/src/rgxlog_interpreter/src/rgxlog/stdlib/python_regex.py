# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb.

# %% auto 0
__all__ = ['PYRGX_STRING', 'PYRGX', 'py_rgx_string', 'py_rgx_string_out_types', 'py_rgx', 'py_rgx_out_type']

# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 3
import re
from typing import Iterable, Sequence

from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.datatypes.primitive_types import DataTypes

# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 4
...
# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 5
def py_rgx_string_out_types(output_arity: int) -> Sequence:
    return tuple([DataTypes.string] * output_arity)

# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 6
...
# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 7
...
# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 8
def py_rgx_out_type(output_arity: int) -> Sequence:
    return tuple([DataTypes.span] * output_arity)

# %% ../../../../../../nbs/16_src.rgxlog_interpreter.src.rgxlog.stdlib.python_regex.ipynb 9
