# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb.
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 3
import csv
import logging
import os
import re
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 6
from lark.lark import Lark
from pandas import DataFrame
from tabulate import tabulate

# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 7
import spanner_workbench.src.rgxlog_interpreter.src.rgxlog
import spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.engine
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 8
CSV_DELIMITER = ";"
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 9
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 10
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 11
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 12
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 13
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 14
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 15
class Session:
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 16
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 17
@patch
def __repr__(self: Session) -> str:
        return "\n".join([repr(self._symbol_table), repr(self._parse_graph)])

# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 18
@patch
def __str__(self: Session) -> str:
        return f'Symbol Table:\n{str(self._symbol_table)}\n\nTerm Graph:\n{str(self._parse_graph)}'

# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 19
@patch
@no_type_check
def run_commands(self: Session, query: str, print_results: bool = True, format_results: bool = False) -> (
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 20
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 21
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 22
@patch
def set_pass_stack(self: Session, user_stack: List[Type[GenericPass]]) -> List[Type[GenericPass]]:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 23
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 24
@patch
def remove_rule(self: Session, rule: str) -> None:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 25
@patch
def remove_all_rules(self: Session, rule_head: Optional[str] = None) -> None:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 26
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 27
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 28
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 29
@patch
def send_commands_result_into_csv(self: Session, commands: str, csv_file_name: Path, delimiter: str = CSV_DELIMITER) -> None:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 30
@patch
def send_commands_result_into_df(self: Session, commands: str) -> Union[DataFrame, List]:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 31
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 32
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 33
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 34
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 35
@patch
def remove_ie_function(self: Session, name: str) -> None:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 36
@patch
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 37
@patch
def print_all_rules(self: Session, head: Optional[str] = None) -> None:
    """
...
# %% ../../../../../../nbs/19_src.rgxlog_interpreter.src.rgxlog.engine.session.ipynb 38
