# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../nbs/12_src.rgxlog_interpreter.src.rgxlog.engine.execution.ipynb.

# %% auto 0
__all__ = ['OUT_REL_ATTRIBUTE', 'FREE_VAR_PREFIX', 'naive_execution']

# %% ../../../../../../nbs/12_src.rgxlog_interpreter.src.rgxlog.engine.execution.ipynb 3
from fastcore.utils import *

# %% ../../../../../../nbs/12_src.rgxlog_interpreter.src.rgxlog.engine.execution.ipynb 4
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.datatypes.ast_node_types import (Relation, Query,
                                                    IERelation)
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.engine import RgxlogEngineBase
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.state.graphs import EvalState, GraphBase, TermGraphBase, ROOT_TYPE, TermNodeType, TYPE, STATE, VALUE
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.state.symbol_table import SymbolTableBase
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.utils.passes_utils import ParseNodeType

# %% ../../../../../../nbs/12_src.rgxlog_interpreter.src.rgxlog.engine.execution.ipynb 5
OUT_REL_ATTRIBUTE = "output_rel"

FREE_VAR_PREFIX = "COL"

# %% ../../../../../../nbs/12_src.rgxlog_interpreter.src.rgxlog.engine.execution.ipynb 6
