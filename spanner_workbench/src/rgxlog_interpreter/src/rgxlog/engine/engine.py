# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb.

# %% auto 0
__all__ = ['RESERVED_RELATION_PREFIX', 'FALSE_VALUE', 'TRUE_VALUE', 'logger', 'RgxlogEngineBase', 'SqliteEngine']

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 4
import logging
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.datatypes.ast_node_types import RelationDeclaration, AddFact, RemoveFact, Query, IERelation, Relation
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.utils.general_utils import strip_lines, string_to_span, get_free_var_to_relations_dict, get_output_free_var_names, extract_one_relation

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 5
from fastcore.utils import *

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 6
# rgx constants
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 7
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 9
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 10
@patch
def __del__(self: SqliteEngine) -> None:
    self.sql_conn.close()

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 11
@patch
# ~~ simple logic methods ~~
def add_fact(self: SqliteEngine, fact: AddFact) -> None:
    """
    @param fact: the fact to be added
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 13
@patch
def remove_fact(self: SqliteEngine, fact: RemoveFact) -> None:
    num_types = len(fact.type_list)
    col_names = [f"{self._get_col_name(i)}" for i in range(num_types)]
    col_values = [self._convert_relation_term_to_string_or_int(datatype, term) for datatype, term in
                  zip(fact.type_list, fact.term_list)]
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 14
@patch
def query(self: SqliteEngine, query: Query, allow_duplicates: bool = False) -> List[Tuple]:
    """
    Outputs a preformatted query result, e.g. [("a",5),("b",6)].
    notice that `query` isn't a string; it's a `Query` object which inherits from `Relation`.
    for example, parsing the string `?excellent("bill","ted")` yields the following `Query`:
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 15
@patch
def remove_tables(self: SqliteEngine, table_names: Iterable[str]) -> None:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 16
@patch
def remove_table(self: SqliteEngine, table_name: str) -> None:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 17
@patch
def declare_relation_table(self: SqliteEngine, relation_decl: RelationDeclaration) -> None:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 18
@patch
def is_table_exists(self: SqliteEngine, table_name: str) -> bool:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 19
@patch
def clear_relation(self: SqliteEngine, table_name: str) -> None:
    sql_command = f"DELETE FROM {table_name}"
    self._run_sql(sql_command)

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 20
@patch
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 22
@extract_one_relation
@patch
def operator_select(self: SqliteEngine, src_relation: Relation, constant_variables_info: Set[Tuple[int, Any, DataTypes]], *args: Any) -> Relation:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 24
@patch
def operator_join(self: SqliteEngine, relations: List[Relation], *args: Any) -> Relation:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 25
@extract_one_relation
@patch
def operator_project(self: SqliteEngine, src_relation: Relation, project_vars: List[str], *args: Any) -> Relation:
    """
    Performs SQL select.
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 26
@patch
def operator_union(self: SqliteEngine, relations: List[Relation], *args: Any) -> Relation:
    """
    @param relations: a list of relations to unite.
    @return: the united relation.
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 27
@extract_one_relation
@patch
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 29
@patch
@no_type_check
def compute_ie_relation(self: SqliteEngine, ie_relation: IERelation, ie_func: IEFunction, bounding_relation: Optional[Relation]) -> Relation:
    """
    Computes an information extraction relation, returning the result as a normal relation.
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 32
@patch
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 33
@patch
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 34
@patch
def _create_unique_relation(self: SqliteEngine, arity: int, prefix: str = "") -> str:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 35
@patch
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 36
@patch
def _get_col_name(self: SqliteEngine, col_id: int) -> str:
    return f'{SqliteEngine.RELATION_COLUMN_PREFIX}{col_id}'

# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 37
@patch
def _get_all_relation_tuples(self: SqliteEngine, relation: Relation) -> List[Tuple]:
    """
...
# %% ../../../../../../nbs/07_src.rgxlog_interpreter.src.rgxlog.engine.engine.ipynb 38
