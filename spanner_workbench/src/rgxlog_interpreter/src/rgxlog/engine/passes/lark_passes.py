# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb.
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 4
from fastcore.utils import *

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 5
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.datatypes.ast_node_types import (Assignment, ReadAssignment, AddFact, RemoveFact, Query, Rule,
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.engine import RESERVED_RELATION_PREFIX
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.state.graphs import NetxStateGraph
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.state.symbol_table import SymbolTableBase
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.utils.general_utils import (get_free_var_names, get_output_free_var_names, get_input_free_var_names,
                                               fixed_point, check_properly_typed_relation, type_check_rule_free_vars)
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.utils.passes_utils import assert_expected_node_structure, unravel_lark_node, ParseNodeType

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 6
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 7
class GenericPass(ABC):
    @abstractmethod
    def run_pass(self, **kwargs: Any) -> None:
        pass

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 8
class VisitorPass(Visitor, GenericPass):
    def run_pass(self, **kwargs: Any) -> None:
        self.visit(get_tree(**kwargs))

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 9
class VisitorRecursivePass(Visitor_Recursive, GenericPass):
    def run_pass(self, **kwargs: Any) -> None:
        self.visit(get_tree(**kwargs))

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 10
class InterpreterPass(Interpreter, GenericPass):
    def run_pass(self, **kwargs: Any) -> None:
        self.visit(get_tree(**kwargs))

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 11
class TransformerPass(Transformer, GenericPass):
    def run_pass(self, **kwargs: Any) -> Any:
        return self.transform(get_tree(**kwargs))

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 12
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 13
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 14
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 15
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 16
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 17
@no_type_check
@assert_expected_node_structure
@patch
def assignment(self: ConvertStatementsToStructuredNodes, assignment_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 18
@no_type_check
@assert_expected_node_structure
@patch
def read_assignment(self: ConvertStatementsToStructuredNodes, assignment_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 19
@no_type_check
@assert_expected_node_structure
@patch
def add_fact(self: ConvertStatementsToStructuredNodes, fact_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 20
@no_type_check
@assert_expected_node_structure
@patch
def remove_fact(self: ConvertStatementsToStructuredNodes, fact_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 21
@no_type_check
@assert_expected_node_structure
@patch
def query(self: ConvertStatementsToStructuredNodes, query_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 22
@no_type_check
@assert_expected_node_structure
@patch
def relation_declaration(self: ConvertStatementsToStructuredNodes, relation_decl_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 23
@no_type_check
@assert_expected_node_structure
@patch
def rule(self: ConvertStatementsToStructuredNodes, rule_node: LarkNode):
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 24
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 25
@patch
def _assert_var_defined(self: CheckDefinedReferencedVariables, var_name: str) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 26
@patch
def _assert_var_terms_defined(self: CheckDefinedReferencedVariables, term_list: Sequence[DataTypeMapping.term], type_list: Sequence[DataTypes]) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 27
@unravel_lark_node
@patch
def assignment(self: CheckDefinedReferencedVariables, assignment: Assignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 28
@unravel_lark_node
@patch
def read_assignment(self: CheckDefinedReferencedVariables, assignment: ReadAssignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 29
@unravel_lark_node
@patch
def add_fact(self: CheckDefinedReferencedVariables, fact: AddFact) -> None:
    self._assert_var_terms_defined(fact.term_list, fact.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 30
@unravel_lark_node
@patch
def remove_fact(self: CheckDefinedReferencedVariables, fact: RemoveFact) -> None:
    self._assert_var_terms_defined(fact.term_list, fact.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 31
@unravel_lark_node
@patch
def query(self: CheckDefinedReferencedVariables, query: Query) -> None:
    self._assert_var_terms_defined(query.term_list, query.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 32
@unravel_lark_node
@patch
def rule(self: CheckDefinedReferencedVariables, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 33
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 34
@patch
def _assert_relation_exists_and_correct_arity(self: CheckReferencedRelationsExistenceAndArity, relation: Relation) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 35
@unravel_lark_node
@patch
def query(self: CheckReferencedRelationsExistenceAndArity, query: Query) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 36
@unravel_lark_node
@patch
def add_fact(self: CheckReferencedRelationsExistenceAndArity, fact: AddFact) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 37
@unravel_lark_node
@patch
def remove_fact(self: CheckReferencedRelationsExistenceAndArity, fact: RemoveFact) -> None:
    # a fact is defined by a relation reference, so we can simply use the utility function
    self._assert_relation_exists_and_correct_arity(fact)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 38
@unravel_lark_node
@patch
def rule(self: CheckReferencedRelationsExistenceAndArity, rule: Rule) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 39
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 40
@unravel_lark_node
@patch
def rule(self: CheckReferencedIERelationsExistenceAndArity, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 41
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 42
@unravel_lark_node
@patch
def rule(self: CheckRuleSafety, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 43
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 44
@unravel_lark_node
@patch
def read_assignment(self: TypeCheckAssignments, assignment: ReadAssignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 45
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 46
@unravel_lark_node
@patch
def add_fact(self: TypeCheckRelations, fact: AddFact) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 47
@unravel_lark_node
@patch
def remove_fact(self: TypeCheckRelations, fact: RemoveFact) -> None:
    # a fact is defined by a relation, check if that relation is properly typed
    type_check_passed = check_properly_typed_relation(fact, self.symbol_table)
    if not type_check_passed:
        raise Exception(f'type check failed for fact: "{fact}"')

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 48
@unravel_lark_node
@patch
def query(self: TypeCheckRelations, query: Query) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 49
@unravel_lark_node
@patch
def rule(self: TypeCheckRelations, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 50
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 51
@unravel_lark_node
@patch
def relation_declaration(self: SaveDeclaredRelationsSchemas, relation_decl: RelationDeclaration) -> None:
    self.symbol_table.add_relation_schema(relation_decl.relation_name, relation_decl.type_list, False)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 52
@no_type_check
@unravel_lark_node
@patch
def rule(self: SaveDeclaredRelationsSchemas, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 53
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 54
@unravel_lark_node
@patch
def assignment(self: ResolveVariablesReferences, assignment: Assignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 55
@unravel_lark_node
@patch
def read_assignment(self: ResolveVariablesReferences, assignment: ReadAssignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 56
@patch
@no_type_check
def _resolve_var_terms(self: ResolveVariablesReferences, term_list: Sequence[DataTypeMapping.term], type_list: Sequence[DataTypes]) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 58
@unravel_lark_node
@patch
def query(self: ResolveVariablesReferences, query: Query) -> None:
    self._resolve_var_terms(query.term_list, query.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 60
@unravel_lark_node
@patch
def add_fact(self: ResolveVariablesReferences, fact: AddFact) -> None:
    self._resolve_var_terms(fact.term_list, fact.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 61
@unravel_lark_node
@patch
def remove_fact(self: ResolveVariablesReferences, fact: RemoveFact) -> None:
    self._resolve_var_terms(fact.term_list, fact.type_list)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 62
@unravel_lark_node
@patch
def rule(self: ResolveVariablesReferences, rule: Rule) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 63
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 64
@unravel_lark_node
@patch
def assignment(self: ExecuteAssignments, assignment: Assignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 65
@unravel_lark_node
@patch
def read_assignment(self: ExecuteAssignments, assignment: ReadAssignment) -> None:
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 66
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 67
@patch
def _add_statement_to_parse_graph(self: AddStatementsToNetxParseGraph, statement_type: ParseNodeType, statement_value: Any) -> None:
    """
...
# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 68
@unravel_lark_node
@patch
def add_fact(self: AddStatementsToNetxParseGraph, fact: AddFact) -> None:
    self._add_statement_to_parse_graph(ParseNodeType.ADD_FACT, fact)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 69
@unravel_lark_node
@patch
def remove_fact(self: AddStatementsToNetxParseGraph, fact: RemoveFact) -> None:
    self._add_statement_to_parse_graph(ParseNodeType.REMOVE_FACT, fact)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 70
@unravel_lark_node
@patch
def query(self: AddStatementsToNetxParseGraph, query: Query) -> None:
    self._add_statement_to_parse_graph(ParseNodeType.QUERY, query)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 71
@unravel_lark_node
@patch
def relation_declaration(self: AddStatementsToNetxParseGraph, relation_decl: RelationDeclaration) -> None:
    self._add_statement_to_parse_graph(ParseNodeType.RELATION_DECLARATION, relation_decl)

# %% ../../../../../../../nbs/09_src.rgxlog_interpreter.src.rgxlog.engine.passes.lark_passes.ipynb 72
@unravel_lark_node
@patch
def rule(self: AddStatementsToNetxParseGraph, rule: Rule) -> None:
