# AUTOGENERATED! DO NOT EDIT! File to edit: ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb.
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 4
...
from spanner_workbench.src.rgxlog_interpreter.src.rgxlog.engine.datatypes.ast_node_types import Relation, Rule, IERelation
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 5
from fastcore.utils import *

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 6
PRETTY_INDENT = " " * 4
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 7
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 8
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 9
class GraphBase(ABC):
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 10
@patch
@abstractmethod
def add_node(self: GraphBase, node_id: Optional[GraphBase.NodeIdType] = None, **attr: Dict) -> GraphBase.NodeIdType:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 12
@patch
@abstractmethod
def get_root_id(self: GraphBase) -> GraphBase.NodeIdType:
    """
    @return: the node id of the root of the graph.
    """
    pass

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 13
@patch
@abstractmethod
def remove_node(self: GraphBase, node_id: GraphBase.NodeIdType) -> None:
    """
...
@patch
@abstractmethod
def add_edge(self: GraphBase, father_id: GraphBase.NodeIdType, son_id: GraphBase.NodeIdType, **attr: Dict) -> None:
    """
...
@patch
@abstractmethod
def pre_order_dfs_from(self: GraphBase, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 14
@patch
def pre_order_dfs(self: GraphBase) -> Iterable[GraphBase.NodeIdType]:
    """
    @return: an iterable of the node ids generated from a depth-first-search pre-ordering starting at the root
    of the graph.
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 15
@patch
@abstractmethod
def post_order_dfs_from(self: GraphBase, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    """
    ...
    pass
@patch
def post_order_dfs(self: GraphBase) -> Iterable[GraphBase.NodeIdType]:
    """
    @return: an iterable of the node ids generated from a depth-first-search post-ordering starting at the root
    of the graph.
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 16
@patch
@abstractmethod
def get_children(self: GraphBase, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 17
@patch
def get_child(self: GraphBase, node_id: GraphBase.NodeIdType) -> GraphBase.NodeIdType:
    """
    @param node_id: a node id.
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 18
@patch
@abstractmethod
def get_parents(self: GraphBase, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    """
    @param node_id: a node id.
    @return: the parents (predecessors) of the node.
    """

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 20
@patch
def get_parent(self: GraphBase, node_id: GraphBase.NodeIdType) -> GraphBase.NodeIdType:
    """
    @param node_id: a node id.
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 21
@patch
@abstractmethod
def is_contains_node(self: GraphBase, node_id: GraphBase.NodeIdType) -> bool:
    """
...
@patch
@abstractmethod
def set_node_attribute(self: GraphBase, node_id: GraphBase.NodeIdType, attr_name: str, attr_value: Any) -> None:
    """
...
@patch
@abstractmethod
def get_node_attributes(self: GraphBase, node_id: GraphBase.NodeIdType) -> Dict[str, Any]:
    """
    @param node_id: a node id.
...
@patch
@abstractmethod
def _get_node_string(self: GraphBase, node_id: GraphBase.NodeIdType) -> str:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 22
@patch
def get_all_nodes_with_attributes(self: GraphBase, sub_graph_root: Optional[GraphBase.NodeIdType] = None, **attributes: Any) -> Iterable[GraphBase.NodeIdType]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 23
@patch
def _pretty_aux(self: GraphBase, node_id: GraphBase.NodeIdType, level: int) -> List[str]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 24
@patch
def pretty(self: GraphBase) -> str:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 25
@patch
def __str__(self: GraphBase) -> str:
    return self.pretty()

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 26
@patch
def __getitem__(self: GraphBase, node_id: GraphBase.NodeIdType) -> Dict:
    return self.get_node_attributes(node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 27
class NetxGraph(GraphBase):
    ...
    def add_node(self, node_id: Optional[GraphBase.NodeIdType] = None, **attr: Dict) -> GraphBase.NodeIdType:
        pass
    ...
    def add_edge(self, father_id: GraphBase.NodeIdType, son_id: GraphBase.NodeIdType, **attr: Dict) -> None:
        pass
    ...
    def get_children(self, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
        pass
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 28
@patch
def add_node(self: NetxGraph, node_id: Optional[GraphBase.NodeIdType] = None, **attr: Any) -> GraphBase.NodeIdType:
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 29
@patch
def get_root_id(self: NetxGraph) -> GraphBase.NodeIdType:
    return self._root_id

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 30
@patch
def remove_node(self: NetxGraph, node_id: GraphBase.NodeIdType) -> None:
    self._graph.remove_node(node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 31
@patch
def add_edge(self: NetxGraph, father_id: GraphBase.NodeIdType, son_id: GraphBase.NodeIdType, **attr: Any) -> None:
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 32
@patch
def pre_order_dfs_from(self: NetxGraph, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    return nx.dfs_preorder_nodes(self._graph, node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 33
@patch
def post_order_dfs_from(self: NetxGraph, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    return nx.dfs_postorder_nodes(self._graph, node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 34
@patch
def get_children(self: NetxGraph, node_id: GraphBase.NodeIdType) -> Sequence[GraphBase.NodeIdType]:
    return list(self._graph.successors(node_id))

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 35
@patch
def set_node_attribute(self: NetxGraph, node_id: GraphBase.NodeIdType, attr_name: str, attr_value: Any) -> None:
    self._graph.nodes[node_id][attr_name] = attr_value

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 36
@patch
def get_node_attributes(self: NetxGraph, node_id: GraphBase.NodeIdType) -> Dict[str, Any]:
    return self._graph.nodes[node_id].copy()

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 37
@patch
def _get_node_string(self: NetxGraph, node_id: GraphBase.NodeIdType) -> str:
    node_attrs = self.get_node_attributes(node_id)
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 38
@patch
def is_contains_node(self: NetxGraph, node_id: GraphBase.NodeIdType) -> bool:
    return self._graph.has_node(node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 39
@patch
def get_parents(self: NetxGraph, node_id: GraphBase.NodeIdType) -> Iterable[GraphBase.NodeIdType]:
    return self._graph.predecessors(node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 40
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 41
@patch
def add_node(self: NetxStateGraph, node_id: Optional[GraphBase.NodeIdType] = None, **attr: Any) -> GraphBase.NodeIdType:
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 42
@patch
def add_edge(self: NetxStateGraph, father_id: GraphBase.NodeIdType, son_id: GraphBase.NodeIdType, **attr: Any) -> None:
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 43
@patch
def _get_node_string(self: NetxStateGraph, node_id: GraphBase.NodeIdType) -> str:
    node_attrs = self.get_node_attributes(node_id)
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 44
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 45
@patch
def _add_relation(self: DependencyGraph, relation: Relation) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 46
@patch
def is_dependent(self: DependencyGraph, head_rel: Relation, body_rel: Relation) -> bool:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 47
@patch
def add_dependencies(self: DependencyGraph, head_relation: Relation, body_relations: Set[Relation]) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 48
@patch
def remove_relation(self: DependencyGraph, relation_name: str) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 49
@patch
def remove_rule(self: DependencyGraph, rule: Rule) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 50
@patch
def get_mutually_recursive_relations(self: DependencyGraph, relation_name: str) -> Set[str]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 51
@patch
def _get_node_string(self: DependencyGraph, node_id: GraphBase.NodeIdType) -> str:
    # for nicer printing format
    return str(node_id)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 52
@patch
def is_relation_in_use(self: DependencyGraph, relation_name: str) -> bool:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 53
@patch
def __str__(self: DependencyGraph) -> str:
    return self.__class__.__name__ + " is:\n" + super().__str__()

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 54
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 55
@patch
@abstractmethod
def add_rule_to_term_graph(self: TermGraphBase, rule: Rule) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 56
@patch
@abstractmethod
def remove_rule(self: TermGraphBase, rule: str) -> bool:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 57
@patch
def add_rule_node(self: TermGraphBase, rule: Rule, nodes: Set[str]) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 58
@patch
def _get_all_rules_with_head(self: TermGraphBase, relation_name: str) -> List[str]:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 59
@patch
def remove_rules_with_head(self: TermGraphBase, rule_head_name: str) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 60
@patch
def print_all_rules(self: TermGraphBase, head: Optional[str]) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 61
@patch
def get_mutually_recursive_relations(self: TermGraphBase, relation_name: str) -> Set[str]:
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 62
@patch
def __str__(self: TermGraphBase) -> str:
    return super().__str__() + "\n" + str(self._dependency_graph)

# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 63
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 64
@patch
def add_relation(self: TermGraph, relation: Relation) -> GraphBase.NodeIdType:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 65
@patch
def get_relation_union_node(self: TermGraph, relation_name: str) -> GraphBase.NodeIdType:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 66
@patch
@no_type_check
def add_rule_to_term_graph(self: TermGraph, rule: Rule) -> None:
    """
...
# %% ../../../../../../../nbs/06_src.rgxlog_interpreter.src.rgxlog.engine.state.graphs.ipynb 67
@patch
def remove_rule(self: TermGraph, rule: str) -> bool:
    """
