# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/tests/05_tests_utils.ipynb.
...
from ..session import queries_to_string, Session

TEMP_FILE_NAME = "temp"

# %% ../../nbs/tests/05_tests_utils.ipynb 4
...
# %% ../../nbs/tests/05_tests_utils.ipynb 5
...
# %% ../../nbs/tests/05_tests_utils.ipynb 6
...
# %% ../../nbs/tests/05_tests_utils.ipynb 7
def split_to_tables(result: str) -> List[str]:
    """
    @param result: spanner_workbench's output.
    @return: List of strings, each string represents a table.
    """

    # in spanner_workbench's output, all tables are separated by two consecutive \n.
    return result.split("\n\n")

# %% ../../nbs/tests/05_tests_utils.ipynb 8
...
# %% ../../nbs/tests/05_tests_utils.ipynb 9
@no_type_check
...
# %% ../../nbs/tests/05_tests_utils.ipynb 10
...
# %% ../../nbs/tests/05_tests_utils.ipynb 11
...
# %% ../../nbs/tests/05_tests_utils.ipynb 12
