...
# %% auto 0
__all__ = ['JAVA_MIN_VERSION', 'NLP_URL', 'NLP_DIR_NAME', 'current_dir', 'path_parts', 'CURR_DIR', 'NLP_DIR_PATH',
           'JAVA_DOWNLOADER', 'INSTALLATION_PATH', 'STANFORD_ZIP_GOOGLE_DRIVE_ID', 'STANFORD_ZIP_NAME',
           'STANFORD_ZIP_PATH', 'logger', 'Tokenize', 'SSplit', 'POS', 'Lemma', 'NER', 'EntityMentions', 'RGXNer',
           'TokensRegex', 'CleanXML', 'Parse', 'DepParse', 'Coref', 'OpenIE', 'KBP', 'Quote', 'Sentiment', 'TrueCase',
           'UDFeats', 'tokenize_wrapper', 'ssplit_wrapper', 'pos_wrapper', 'lemma_wrapper', 'ner_wrapper',
           'entitymentions_wrapper', 'regexner_wrapper', 'tokensregex_wrapper', 'cleanxml_wrapper', 'parse_wrapper',
           'dependency_parse_wrapper', 'coref_wrapper', 'openie_wrapper', 'kbp_wrapper', 'quote_wrapper',
           'sentiment_wrapper', 'truecase_wrapper', 'udfeats_wrapper']
...
CURR_DIR = Path(os.path.join(current_dir,'spanner_workbench','rgxlog'))
