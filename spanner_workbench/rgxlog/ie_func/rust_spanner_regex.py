...
# %% ../../../nbs/ie_func/04d_rust_spanner_regex.ipynb 8
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../../nbs/ie_func/04d_rust_spanner_regex.ipynb 10
...
REGEX_FOLDER_PATH = Path(os.path.join(os.path.dirname(os.getcwd()),'spanner_workbench','rgxlog')) / REGEX_FOLDER_NAME
...
# %% ../../../nbs/ie_func/04d_rust_spanner_regex.ipynb 14
...
# %% ../../../nbs/ie_func/04d_rust_spanner_regex.ipynb 16
WINDOWS_OS = "win32"
