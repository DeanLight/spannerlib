...
# %% auto 0
__all__ = ['logger', 'WINDOWS_OS', 'IS_POSIX', 'GOOGLE_DRIVE_URL', 'GOOGLE_DRIVE_CHUNK_SIZE', 'wrapped_patch',
           'kill_process_and_children', 'run_cli_command', 'download_file_from_google_drive']
