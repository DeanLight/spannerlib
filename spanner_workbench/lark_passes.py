# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01c_lark_passes.ipynb.
...
class CheckReservedRelationNames(InterpreterPass):
    ...
    if such relations exist, throw an exception as this is a reserved name for spanner_workbench.
    """
