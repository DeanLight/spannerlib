...
from .expected_grammar import spanner_workbench_expected_children_names_lists
...
def assert_expected_node_structure_aux(lark_node: Any # the lark node to be checked
    ...
    if isinstance(lark_node, LarkNode):
        ...
        if node_type in spanner_workbench_expected_children_names_lists:
            ...
            expected_children_names_lists = spanner_workbench_expected_children_names_lists[node_type]
