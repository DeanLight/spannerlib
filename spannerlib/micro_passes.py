...
# %% auto 0
__all__ = ['logger', 'remove_new_lines_from_strings', 'check_referenced_vars_exist', 'rules_to_dataclasses',
...
# %% ../nbs/020_semantic_checks.ipynb 13
...
# %% ../nbs/020_semantic_checks.ipynb 23
