  ...
  'syms': { 'spannerlib.adding_inference_rules_to_term_graph': { 'spannerlib.adding_inference_rules_to_term_graph.AddRulesToTermGraph': ( 'adding_inference_rules_to_term_graph.html#addrulestotermgraph',
            ...
            'spannerlib.ie_func.rust_spanner_regex': { 'spannerlib.ie_func.rust_spanner_regex._format_spanner_span_output': ( 'ie_func/rust_spanner_regex.html#_format_spanner_span_output',
                                                       ...
                                                       'spannerlib.ie_func.rust_spanner_regex.rgx_string_out_type': ( 'ie_func/rust_spanner_regex.html#rgx_string_out_type',
                                                                                                                      'spannerlib/ie_func/rust_spanner_regex.py')},
            'spannerlib.magic': { 'spannerlib.magic.MagicSession': ('magic_system.html#magicsession', 'spannerlib/magic.py'),
                                  'spannerlib.magic.MagicSession.__init__': ( 'magic_system.html#magicsession.__init__',
                                                                              'spannerlib/magic.py'),
                                  'spannerlib.magic.MagicSession.set': ('magic_system.html#magicsession.set', 'spannerlib/magic.py'),
