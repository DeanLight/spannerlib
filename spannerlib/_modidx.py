  ...
  'syms': { 'spannerlib.adding_inference_rules_to_term_graph': { 'spannerlib.adding_inference_rules_to_term_graph.AddRulesToTermGraph': ( 'adding_inference_rules_to_term_graph.html#addrulestotermgraph',
            ...
            'spannerlib.tutorials.basic': { 'spannerlib.tutorials.basic._get_client': ( 'tutorials/basic_tasks.html#_get_client',
                                            ...
                                            'spannerlib.tutorials.basic.split': ( 'tutorials/basic_tasks.html#split',
                                                                                  'spannerlib/tutorials/basic.py')},
            'spannerlib.tutorials.copilot': { 'spannerlib.tutorials.copilot._ast_to_string': ( 'tutorials/llm_code_documentation_example '
                                                                                               'copy.html#_ast_to_string',
                                                                                               'spannerlib/tutorials/copilot.py'),
                                              'spannerlib.tutorials.copilot._get_character_position': ( 'tutorials/llm_code_documentation_example '
                                                                                                        'copy.html#_get_character_position',
                                                                                                        'spannerlib/tutorials/copilot.py'),
                                              'spannerlib.tutorials.copilot._get_lines': ( 'tutorials/llm_code_documentation_example '
                                                                                           'copy.html#_get_lines',
                                                                                           'spannerlib/tutorials/copilot.py'),
                                              'spannerlib.tutorials.copilot._print_file_xml': ( 'tutorials/llm_code_documentation_example '
                                                                                                'copy.html#_print_file_xml',
                                                                                                'spannerlib/tutorials/copilot.py'),
                                              'spannerlib.tutorials.copilot._py_to_xml': ( 'tutorials/llm_code_documentation_example '
                                                                                           'copy.html#_py_to_xml',
                                                                                           'spannerlib/tutorials/copilot.py'),
                                              'spannerlib.tutorials.copilot._xml_to_string': ( 'tutorials/llm_code_documentation_example '
                                                                                               'copy.html#_xml_to_string',
                                                                                               'spannerlib/tutorials/copilot.py'),
