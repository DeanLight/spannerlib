...
# %% auto 0
__all__ = ['logger', 'PREDEFINED_IE_FUNCS', 'PREDEFINED_AGG_FUNCS', 'Session', 'test_session']
...
class Session():
    ...
    def clear(self,register_stdlib=True):
        ...
        if not register_stdlib:
            return
        for ie_def in PREDEFINED_IE_FUNCS:
            self.register(*ie_def)
        for agg_def in PREDEFINED_AGG_FUNCS:
