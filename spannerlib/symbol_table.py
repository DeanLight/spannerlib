# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/91b_symbol_table.ipynb.

# %% auto 0
__all__ = ['SymbolTableBase', 'SymbolTable']

# %% ../nbs/91b_symbol_table.ipynb 5
#| output: false
