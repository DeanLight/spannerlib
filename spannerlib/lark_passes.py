...
# %% ../nbs/010_micro_passes.ipynb 7
class GenericPass(ABC):
    @abstractmethod
    def run_pass(self, **kwargs: Any) -> None:
        pass

# %% ../nbs/010_micro_passes.ipynb 8
