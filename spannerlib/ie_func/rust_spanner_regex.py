# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/ie_func/04d_rust_spanner_regex.ipynb.
...
# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 7
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 9
...
# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 11
...
# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 13
...
# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 15
WINDOWS_OS = "win32"
...
# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 17
ESCAPED_STRINGS_PATTERN = re.compile(r'"([^"\\]*(?:\\.[^"\\]*)*)"', re.DOTALL)
SPAN_PATTERN = re.compile(r"(?P<start>\d+), ?(?P<end>\d+)")

# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 18
# etc
TEMP_FILE_NAME = "temp"

logger = logging.getLogger(__name__)

# %% ../../nbs/ie_func/04d_rust_spanner_regex.ipynb 19
