...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 4
import logging
import re
import tempfile
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 7
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 9
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 11
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 13
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 15
WINDOWS_OS = "win32"
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 17
ESCAPED_STRINGS_PATTERN = re.compile(r'"([^"\\]*(?:\\.[^"\\]*)*)"', re.DOTALL)
SPAN_PATTERN = re.compile(r"(?P<start>\d+), ?(?P<end>\d+)")

# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 18
# etc
TEMP_FILE_NAME = "temp"

logger = logging.getLogger(__name__)

# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 19
def _is_installed_package() -> bool:
    return Path(REGEX_EXE_PATH).is_file()

# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 20
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 25
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 26
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 27
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 28
RGX = [
    'fast_rgx_span',
    rgx_span,
    [str,str],
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 29
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 30
RGX_STRING = [
    'fast_rgx',
    rgx_string,
    [str,str],
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 31
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 32
RGX_FROM_FILE = [
    'fast_rgx_span_f',
    rgx_span_from_file,
    [str,str],
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 33
...
# %% ../../nbs/callbacks/04d_rust_spanner_regex.ipynb 34
RGX_STRING_FROM_FILE = [
    'fast_rgx_f',
    rgx_string_from_file,
    [str,str],
