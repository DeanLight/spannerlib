# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb.

# %% auto 0
__all__ = ['DOWNLOAD_RUST_URL', 'PACKAGE_GIT_URL', 'PACKAGE_NAME', 'PACKAGE_WIN_FILENAME', 'REGEX_FOLDER_NAME',
           'REGEX_FOLDER_PATH', 'REGEX_TEMP_PATH', 'REGEX_EXE_PATH_POSIX', 'REGEX_EXE_PATH_WIN', 'RUSTUP_TOOLCHAIN',
           'CARGO_CMD_ARGS', 'RUSTUP_CMD_ARGS', 'SHORT_TIMEOUT', 'CARGO_TIMEOUT', 'RUSTUP_TIMEOUT', 'TIMEOUT_MINUTES',
           'WINDOWS_OS', 'WHICH_WORD', 'REGEX_EXE_PATH', 'ESCAPED_STRINGS_PATTERN', 'SPAN_PATTERN', 'TEMP_FILE_NAME',
           'logger', 'RGX', 'RGX_STRING', 'RGX_FROM_FILE', 'RGX_STRING_FROM_FILE', 'download_and_install_rust_regex',
           'rgx_span_out_type', 'rgx_string_out_type', 'rgx', 'rgx_span', 'rgx_string', 'rgx_span_from_file',
           'rgx_string_from_file']

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 4
import logging
import re
import tempfile
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 7
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 9
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 11
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 13
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 15
WINDOWS_OS = "win32"
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 17
ESCAPED_STRINGS_PATTERN = re.compile(r'"([^"\\]*(?:\\.[^"\\]*)*)"', re.DOTALL)
SPAN_PATTERN = re.compile(r"(?P<start>\d+), ?(?P<end>\d+)")

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 18
# etc
TEMP_FILE_NAME = "temp"

logger = logging.getLogger(__name__)

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 19
def _is_installed_package() -> bool:
    return Path(REGEX_EXE_PATH).is_file()

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 20
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 22
@no_type_check
def rgx_span_out_type(output_arity: int):
    return tuple([Span] * output_arity)

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 23
@no_type_check
def rgx_string_out_type(output_arity: int):
    return tuple([str] * output_arity)

# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 24
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 25
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 26
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 27
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 28
RGX = [
    'fast_rgx_span',
    rgx_span,
    [str,str],
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 29
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 30
RGX_STRING = [
    'fast_rgx',
    rgx_string,
    [str,str],
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 31
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 32
RGX_FROM_FILE = [
    'fast_rgx_span_f',
    rgx_span_from_file,
    [str,str],
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 33
...
# %% ../../nbs/callbacksC/04d_rust_spanner_regex.ipynb 34
RGX_STRING_FROM_FILE = [
    'fast_rgx_f',
    rgx_string_from_file,
    [str,str],
