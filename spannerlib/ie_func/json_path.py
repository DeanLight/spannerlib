# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/callbacksC/003_json_path.ipynb.

# %% auto 0
__all__ = ['json_path']

# %% ../../nbs/callbacksC/003_json_path.ipynb 4
...
# %% ../../nbs/callbacksC/003_json_path.ipynb 5
...
# %% ../../nbs/callbacksC/003_json_path.ipynb 6
def json_path(
...
# %% ../../nbs/callbacksC/003_json_path.ipynb 8
DefaultIEs().add(
    'json_path',json_path,
    [str,str],
    [str,str],
