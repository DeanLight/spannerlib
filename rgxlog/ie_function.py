# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/spanner_workbench/nbs/03b_ie_function.ipynb.

# %% auto 0
__all__ = ['IEFunction']

# %% ../nbs/spanner_workbench/nbs/03b_ie_function.ipynb 4
#| output: false
from typing import Iterable, Callable, Union, Tuple, List, Sequence, Any
from .primitive_types import DataTypes

# %% ../nbs/spanner_workbench/nbs/03b_ie_function.ipynb 5
class IEFunction:
    """
