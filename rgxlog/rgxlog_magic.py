# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/spanner_workbench/nbs/04b_rgxlog_magic.ipynb.

# %% auto 0
__all__ = ['RgxlogMagic']

# %% ../nbs/spanner_workbench/nbs/04b_rgxlog_magic.ipynb 3
from typing import Optional

from IPython.core.magic import (Magics, magics_class, line_cell_magic)

# %% ../nbs/spanner_workbench/nbs/04b_rgxlog_magic.ipynb 4
@magics_class
