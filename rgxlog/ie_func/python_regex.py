# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb.

# %% auto 0
__all__ = ['PYRGX_STRING', 'PYRGX', 'py_rgx_string', 'py_rgx_string_out_types', 'py_rgx', 'py_rgx_out_type']

# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 3
import re
from typing import Iterable, Sequence

from ..primitive_types import DataTypes

# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 4
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 5
def py_rgx_string_out_types(output_arity: int) -> Sequence:
    return tuple([DataTypes.string] * output_arity)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 6
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 7
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 8
def py_rgx_out_type(output_arity: int) -> Sequence:
    return tuple([DataTypes.span] * output_arity)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04c_python_regex.ipynb 9
