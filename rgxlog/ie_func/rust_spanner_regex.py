# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb.
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 4
import logging
import re
import tempfile
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 6
RUST_RGX_IN_TYPES = [DataTypes.string, DataTypes.string]

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 8
DOWNLOAD_RUST_URL = "https://rustup.rs/"

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 10
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 12
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 14
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 16
WINDOWS_OS = "win32"
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 18
ESCAPED_STRINGS_PATTERN = re.compile(r'"([^"\\]*(?:\\.[^"\\]*)*)"', re.DOTALL)
SPAN_PATTERN = re.compile(r"(?P<start>\d+), ?(?P<end>\d+)")

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 19
# etc
TEMP_FILE_NAME = "temp"

logger = logging.getLogger(__name__)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 20
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 21
def _is_installed_package() -> bool:
    return Path(REGEX_EXE_PATH).is_file()

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 22
@no_type_check
def rgx_span_out_type(output_arity: int) -> Tuple[DataTypes]:
    return tuple([DataTypes.span] * output_arity)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 23
@no_type_check
def rgx_string_out_type(output_arity: int) -> Tuple[DataTypes]:
    return tuple([DataTypes.string] * output_arity)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 24
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 25
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 26
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 27
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 28
RGX = dict(ie_function=rgx_span,
           ie_function_name='rgx_span',
           in_rel=RUST_RGX_IN_TYPES,
           out_rel=rgx_span_out_type)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 29
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 30
RGX_STRING = dict(ie_function=rgx_string,
                  ie_function_name='rgx_string',
                  in_rel=RUST_RGX_IN_TYPES,
                  out_rel=rgx_string_out_type)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 31
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 32
RGX_FROM_FILE = dict(ie_function=rgx_span_from_file,
                     ie_function_name='rgx_span_from_file',
                     in_rel=RUST_RGX_IN_TYPES,
                     out_rel=rgx_span_out_type)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 33
...
# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 34
RGX_STRING_FROM_FILE = dict(ie_function=rgx_string_from_file,
                            ie_function_name='rgx_string_from_file',
                            in_rel=RUST_RGX_IN_TYPES,
                            out_rel=rgx_string_out_type)

# %% ../../nbs/spanner_workbench/nbs/ie_func/04d_rust_spanner_regex.ipynb 35
#| eval: false
