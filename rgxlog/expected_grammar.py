# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/spanner_workbench/nbs/01a_expected_grammar.ipynb.

# %% auto 0
__all__ = ['rgxlog_expected_children_names_lists']

# %% ../nbs/spanner_workbench/nbs/01a_expected_grammar.ipynb 3
from typing import Sequence, Dict

# %% ../nbs/spanner_workbench/nbs/01a_expected_grammar.ipynb 5
